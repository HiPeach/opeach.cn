            ...
            (n.default =
              ...
              f =
                function () {
                  ...
                  if (
                    (p.addClass(C.body, "stop-scrolling"),
                    y.resetInput(),
                    t === S)
                  )
                    return (
                  ...
                  g.default(n),
                    y.fixVerticalPosition(),
                    y.openModal(arguments[1]);
                  for (
                    var a = y.getModal(),
                      r = a.querySelectorAll("button"),
                      s = [
                        "onclick",
                        "onmouseover",
                        "onmouseout",
              ...
              (a.close = f.close =
                function () {
                  var t = y.getModal(),
                    e =
                      (p.fadeOut(y.getOverlay(), 5),
                      p.fadeOut(t, 5),
                      p.removeClass(t, "showSweetAlert"),
                      p.addClass(t, "hideSweetAlert"),
                      p.removeClass(t, "visible"),
                      t.querySelector(".sa-icon.sa-success")),
                    e =
                      (p.removeClass(e, "animate"),
                      p.removeClass(
                      ...
                      t.querySelector(".sa-icon.sa-error")),
                    e =
                      (p.removeClass(e, "animateErrorIcon"),
                      p.removeClass(
                        e.querySelector(".sa-x-mark"),
                        "animateXMark"
                      ),
                      t.querySelector(".sa-icon.sa-warning"));
                  return (
                    p.removeClass(e, "pulseWarning"),
                    p.removeClass(e.querySelector(".sa-body"), "pulseWarningIns"),
                    p.removeClass(e.querySelector(".sa-dot"), "pulseWarningIns"),
                    setTimeout(function () {
                      var e = t.getAttribute("data-custom-class");
                      p.removeClass(t, e);
                    }, 300),
                    p.removeClass(C.body, "stop-scrolling"),
                    (w.onkeydown = c),
              ...
              (a.showInputError = f.showInputError =
                function (e) {
                  var t = y.getModal(),
                    n = t.querySelector(".sa-input-error"),
                    n =
                      (p.addClass(n, "show"),
                      t.querySelector(".sa-error-container"));
                  p.addClass(n, "show"),
              ...
              (a.resetInputError = f.resetInputError =
                function (e) {
                  ...
                  var e = y.getModal(),
                    ...
                    t =
                      ...
                      e.querySelector(".sa-error-container"));
                  p.removeClass(t, "show");
                }),
              (a.disableButtons = f.disableButtons =
                function (e) {
                  var t = y.getModal(),
              ...
              handleButton: function (e, t, n) {
                ...
                switch (
                  (l &&
                    ...
                    (a = v.colorLuminance(o, -0.04)),
                    (r = v.colorLuminance(o, -0.14))),
                  e.type)
                ) {
                  case "mouseover":
                    d(a);
            ...
            (n.hasClass = o),
              ...
              (n.fadeOut = function (e, t) {
                ...
                var n,
                  ...
                  a =
                    ((n = function () {
                      (e.style.opacity =
                        +e.style.opacity - (new Date() - o) / 100),
                        (o = +new Date()),
                        0 < +e.style.opacity
                          ? setTimeout(a, t)
                          : (e.style.display = "none");
              ...
              (n.fireClick = function (e) {
                ...
                "function" == typeof MouseEvent
                  ? ((t = new MouseEvent("click", {
                    ...
                    e.dispatchEvent(t))
                  : C.createEvent
                  ? ((t = C.createEvent("MouseEvents")).initEvent(
                      "click",
                      !1,
                      !1
                    ),
              ...
              (n.stopEventPropagation = function (e) {
                "function" == typeof e.stopPropagation
                  ...
                  : w.event &&
                    w.event.hasOwnProperty("cancelBubble") &&
                    (w.event.cancelBubble = !0);
              });
          },
          {}
        ],
          ...
          function (e, t, n) {
            ...
            (n.default = function (e, t, n) {
              ...
              if (-1 !== [9, 13, 32, 27].indexOf(o)) {
                for (
                  var l = e.target || e.srcElement, i = -1, u = 0;
                  u < s.length;
                  u++
                )
                  if (l === s[u]) {
                ...
                9 === o
                  ? ((l = -1 === i ? a : i === s.length - 1 ? s[0] : s[i + 1]),
                    c.stopEventPropagation(e),
                    l.focus(),
                    t.confirmButtonColor &&
                      d.setFocusStyle(l, t.confirmButtonColor))
                  : 13 === o
                  ? "INPUT" === l.tagName && (l = a).focus()
                  : 27 === o &&
                    !0 === t.allowEscapeKey &&
                    c.fireClick((l = r), e);
              }
          ...
          function (e, t, n) {
            ...
            function a() {
              ...
              for (e.innerHTML = u.default; e.firstChild; )
                C.body.appendChild(e.firstChild);
            }
            Object.defineProperty(n, "__esModule", { value: !0 });
            var r,
              s = e("./utils"),
            ...
            (n.sweetAlertInitialize = a),
              ...
              (n.openModal = function (e) {
                ...
                l.fadeIn(p(), 10),
                  ...
                  (w.previousActiveElement = C.activeElement);
                t.querySelector("button.confirm").focus(),
                  setTimeout(function () {
                    l.addClass(t, "visible");
                  }, 500);
                var n,
                  o = t.getAttribute("data-timer");
                "null" !== o &&
                  "" !== o &&
                  ((n = e),
              ...
              (n.resetInput = function () {
                ...
                l.removeClass(e, "show-input"),
                  (t.value = i.default.inputValue),
                  t.setAttribute("type", i.default.inputType),
                  t.setAttribute("placeholder", i.default.inputPlaceholder),
                  m();
              }),
              (n.resetInputError = m),
          ...
          function (e, t, n) {
            ...
            (n.default = function (a) {
              ...
              if (
                ...
                a.text && d.show(o),
                a.customClass
                  ? (d.addClass(r, a.customClass),
                    r.setAttribute("data-custom-class", a.customClass))
                  : ((n = r.getAttribute("data-custom-class")),
                    d.removeClass(r, n),
                    r.setAttribute("data-custom-class", "")),
                d.hide(r.querySelectorAll(".sa-icon")),
                a.type && !u.isIE8())
              ) {
                var o = (function () {
                  ...
                  var n = S,
                    o =
                      (-1 !==
                        ...
                        ((n = r.querySelector(".sa-icon.sa-" + a.type)),
                        d.show(n)),
                      c.getInput());
                  switch (a.type) {
                    case "success":
                      d.addClass(n, "animate"),
                        d.addClass(
                      ...
                      break;
                    case "error":
                      d.addClass(n, "animateErrorIcon"),
                        d.addClass(n.querySelector(".sa-x-mark"), "animateXMark");
                      break;
                    case "warning":
                      d.addClass(n, "pulseWarning"),
                        d.addClass(
                          n.querySelector(".sa-body"),
                          "pulseWarningIns"
                        ),
                        d.addClass(n.querySelector(".sa-dot"), "pulseWarningIns");
                      break;
                    case "input":
                    case "prompt":
                      o.setAttribute("type", a.inputType),
                        (o.value = a.inputValue),
                        o.setAttribute("placeholder", a.inputPlaceholder),
                        d.addClass(r, "show-input"),
                        setTimeout(function () {
                          o.focus(),
              ...
              a.imageUrl &&
                (((n =
                  r.querySelector(".sa-icon.sa-custom")).style.backgroundImage =
                  "url(" + a.imageUrl + ")"),
                d.show(n),
                (e = o = 80),
                a.imageSize &&
                  ((i = (t = a.imageSize.toString().split("x"))[0]),
                  (t = t[1]),
                  i && t
                    ? ((o = i), (e = t))
                    : logStr(
                ...
                r.setAttribute("data-has-cancel-button", a.showCancelButton),
                a.showCancelButton
                  ? (s.style.display = "inline-block")
                  : d.hide(s),
                r.setAttribute("data-has-confirm-button", a.showConfirmButton),
                a.showConfirmButton
                  ? (l.style.display = "inline-block")
                  : d.hide(l),
                a.cancelButtonText &&
                  (s.innerHTML = d.escapeHtml(a.cancelButtonText)),
                a.confirmButtonText &&
                  (l.innerHTML = d.escapeHtml(a.confirmButtonText)),
                a.confirmButtonColor &&
                  ((l.style.backgroundColor = a.confirmButtonColor),
                  (l.style.borderLeftColor = a.confirmLoadingButtonColor),
                  (l.style.borderRightColor = a.confirmLoadingButtonColor),
                  c.setFocusStyle(l, a.confirmButtonColor)),
                r.setAttribute("data-allow-outside-click", a.allowOutsideClick);
              var i = !!a.doneFunction;
              r.setAttribute("data-has-done-function", i),
                a.animation
                  ? "string" == typeof a.animation
                    ? r.setAttribute("data-animation", a.animation)
                    : r.setAttribute("data-animation", "pop")
                  : r.setAttribute("data-animation", "none"),
                r.setAttribute("data-timer", a.timer);
            }),
              (t.exports = n.default);
          },
          { "./handle-dom": 4, "./handle-swal-dom": 6, "./utils": 9 }
